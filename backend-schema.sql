...
-- RLS for Friends Table
ALTER TABLE public.friends ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can see their own follow list" ON public.friends
    FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can manage their own follow list" ON public.friends
